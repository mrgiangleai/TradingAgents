...
class AgentState(MessagesState):
    ...
    # Final Advisor (Phase 7, additive -- runs after Portfolio Manager, does
    # not replace final_trade_decision). See docs/agents/final_advisor_design.md.
    final_advisory_report: Annotated[str, "Advisory-only synthesis of final_trade_decision + KeyVolume + Liquidity Sweep"]
